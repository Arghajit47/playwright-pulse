...
def generate_worker_distribution_chart(results):
    ...
    traces_json = json.dumps(hc_series)
...
.step-item {{ 
        ...
        .code-block-status.status-passed {{ background: rgba(16,185,129,0.15); color: #34d399; }}
        .code-block-status.status-failed {{ background: rgba(239,68,68,0.15); color: #f87171; }}
        .code-block-status.status-skipped {{ background: rgba(245,158,11,0.15); color: #fbbf24; }}
        .code-block-status.status-xfailed {{ background: rgba(139,92,246,0.15); color: #a78bfa; }}
        .code-block-dur {{ font-size: 0.78em; color: #6b7280; }}
        .copy-snippet-btn {{
          font-size: 0.78em;
          padding: 2px 10px;
          cursor: pointer;
...
.trace-preview {{ 
        ...
        /* Suppress Highcharts accessibility module injected regions */
